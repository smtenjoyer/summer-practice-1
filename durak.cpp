...
#include <C:/Users/timoh/Desktop/SFML-2.6.1/include/SFML/Window.hpp>
#include <C:/Users/timoh/Desktop/SFML-2.6.1/include/SFML/System.hpp>
#include <iostream>
#include <vector>
#include <random>
#include <algorithm>
...
std::vector<Card> create_deck(const sf::Texture& card_texture) { 
    ...
    { 
        for (const std::string& suit : suits) {
            std::string filename = "C:/Users/timoh/Desktop/durak_2.0/resources/" + std::to_string(value) + suit + ".png"; 
...
int main() {
    ...
    if (!card_texture.loadFromFile("C:/Users/timoh/Desktop/durak_2.0/resources/back.png")) {
        std::cerr << "Ошибка загрузки текстуры карты" << std::endl;
        return 1;
    }
    // Загрузка текстуры стола
    sf::Texture tableTexture;
    if (!tableTexture.loadFromFile("C:/Users/timoh/Desktop/durak_2.0/resources/table.png")) {
    ...
    // Шрифт для текста
    sf::Font font;
    if (!font.loadFromFile("C:/Users/timoh/Desktop/durak_2.0/resources/ffont.ttf")) { 
